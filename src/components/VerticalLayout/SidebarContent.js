          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                ...
                <li>
                  <Link to="#">{this.props.t("Buy/Sell")}</Link>
                </li>
                <li>
            ...
            <ul className="sub-menu" aria-expanded="false">
              ...
              <li>
                <Link to="/#">
                  ...
                  <span key="t-email-templates">{this.props.t("Templates")}</span>
                </Link>
                <ul className="sub-menu" aria-expanded="false">
                  <li>
                    <Link to="#">
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                ...
                <li>
                  <Link to="#">{this.props.t("Blog Details")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                ...
                <li>
                  <Link to="#">{this.props.t("Form Layouts")}</Link>
                </li>
                <li>
                  <Link to="#">
            ...
            <li>
              <Link to="/#" className="has-arrow waves-effect">
                <i className="bx bxs-bar-chart-alt" />
